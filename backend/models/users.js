...
const userSchema = new mongoose.Schema({
  ...
  bg: {
    type: String,
    default:'https://images.unsplash.com/photo-1627213742863-46b836499634?q=80&w=2889&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', 
  },
  email: {
    type: String,
    required: true,
